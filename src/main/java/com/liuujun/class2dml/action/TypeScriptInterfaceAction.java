 ...
 * @author liujun
 */
public class TypeScriptInterfaceAction extends AnAction {

    public TypeScriptInterfaceAction() {
        super(Class2dmlBundle.message("action.typescript.interface.title"));
    }
